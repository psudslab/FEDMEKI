...
#
#python -m torch.distributed.launch --nproc_per_node=1 --master_port=2333 train.py \
#    --stage 1 \
...
#    --save_path  /data/xiaochen/FedMFM/ckpt/octavius_2d_e4_bs64 \
#    --log_path ../ckpt/octavius_2d_e4_bs64/log_rest/ \
#    2>&1 | tee ../ckpt/octavius_2d_e4_bs64/log_rest/train_${now}.log
